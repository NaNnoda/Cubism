...
var TransformMatrix2D;
var init_TransformMatrix2D = __esm({
  "src/Datatypes/TransformMatrix2D.ts"() {
    "use strict";
    TransformMatrix2D = class {
...
// src/State.ts
var CubismCanvasState;
var init_State = __esm({
  "src/State.ts"() {
    "use strict";
    init_TransformMatrix2D();
    CubismCanvasState = class {
...
var LayoutValues, Orientation, Alignment, Direction, Axis, PointerType, GEventKeys;
...
var CubismGlobalEventSystem;
var init_CubismGlobalEventSystem = __esm({
  "src/Events/CubismGlobalEventSystem.ts"() {
    "use strict";
    CubismGlobalEventSystem = class {
      constructor() {
...
var CubismEventManager;
var init_CubismEventManager = __esm({
  "src/Events/CubismEventManager.ts"() {
    "use strict";
    init_Constants();
    CubismEventManager = class {
...
var init_InteractiveElement = __esm({
  "src/Elements/InteractiveElement.ts"() {
    "use strict";
    init_CubismElement();
    InteractiveElement = class extends CubismElement {
      constructor() {
        super(...arguments);
        this.events = {};
      }
...
var PointerHandleableElement;
var init_PointerHandleableElement = __esm({
  "src/Elements/PointerHandleableElement.ts"() {
    "use strict";
    init_InteractiveElement();
    init_Constants();
    PointerHandleableElement = class extends InteractiveElement {
      constructor() {
        super();
...
var PointerPoint;
var init_PointerPoint = __esm({
  "src/Datatypes/PointerPoint.ts"() {
    "use strict";
    init_Point();
    PointerPoint = class extends Point2D {
...
// src/Cubism.ts
var Cubism;
var init_Cubism = __esm({
  "src/Cubism.ts"() {
    "use strict";
    init_CanvasDrawer();
    init_CubismGlobalEventSystem();
    init_CubismEventManager();
    init_Constants();
    init_Point();
    init_PointerHandleableElement();
    init_PointerPoint();
    Cubism = class {
      constructor(canvas) {
...
// src/Theme/Theme.ts
var CubismElementThemeRoot, ColorTheme, OnClickColorTheme, OnHoverColorTheme, FontTheme;
var init_Theme = __esm({
  "src/Theme/Theme.ts"() {
    "use strict";
    init_Colors();
    CubismElementThemeRoot = class {
    ...
    OnClickColorTheme = class extends ColorTheme {
      constructor() {
        super(...arguments);
        this.background = Colors.grey200;
      }
    };
    OnHoverColorTheme = class extends ColorTheme {
      constructor() {
        super(...arguments);
...
var ThemedElement;
var init_ThemedElement = __esm({
  "src/Elements/ThemedElement.ts"() {
    "use strict";
    init_PointerHandleableElement();
    init_Theme();
    ThemedElement = class extends PointerHandleableElement {
      constructor() {
        super();
...
var DraggableRect;
var init_DraggableRect = __esm({
  "src/Elements/DraggableRect.ts"() {
    "use strict";
    init_ThemedElement();
    init_Point();
    DraggableRect = class extends ThemedElement {
      constructor() {
        super(...arguments);
...
var PointerHandleableLayout;
var init_PointerHandleableLayout = __esm({
  "src/Elements/Layouts/PointerHandleableLayout.ts"() {
    "use strict";
    init_PointerPoint();
    init_Constants();
    init_PointerHandleableElement();
    PointerHandleableLayout = class extends PointerHandleableElement {
...
var LinearLayout;
var init_LinearLayout = __esm({
  "src/Elements/Layouts/LinearLayout.ts"() {
    "use strict";
    init_PointerHandleableLayout();
    LinearLayout = class extends PointerHandleableLayout {
    };
  }
});
...
var VerticalLayout;
var init_VerticalLayout = __esm({
  "src/Elements/Layouts/VerticalLayout.ts"() {
    "use strict";
    init_LinearLayout();
    init_Point();
    VerticalLayout = class extends LinearLayout {
      updateChildrenPosition() {
...
var ButtonElement;
var init_ButtonElement = __esm({
  "src/Elements/ButtonElement.ts"() {
    "use strict";
    init_ThemedElement();
    init_Theme();
    ButtonElement = class extends ThemedElement {
  ...
  "src/Index.ts"(exports) {
    ...
    var LiveDemo = class {
      constructor(global) {
        ...
        this.CubismElementThemeRoot = CubismElementThemeRoot;
